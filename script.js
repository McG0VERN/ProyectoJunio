...
function colorRGB2(number1, number2, number3) {
    ...
    let distance = generateNumber(-20, 20) // metiendo un distance entre estos valores, conseguimos que el cubo a seleccionar no sea siempre ni el color más claro ni el más oscuro, por lo que es más dificil encontrarlo    let color = "rgb(" + (number1 + distance + i) + ", " + (number2 + distance + i) + ", " + (number3 + distance + i) + ")";
